...
################################################################################
# vLLM Server Launcher for deepseek-ai/deepseek-coder-33b-instruct
...
#MODEL_NAME="deepseek-ai/deepseek-coder-33b-instruct-AWQ" # AQW
...
MAX_MODEL_LEN=16284           # Max sequence length (input + output)
